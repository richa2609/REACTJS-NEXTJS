...
const POSTS = [
  {
    tag: 'Pet Boarding',
    img: 'https://loremflickr.com/600/440/dogwalker,leash,park?lock=101',
    alt: 'Dog walker leading a dog through the park',
  ...
  {
    tag: 'Vaccine Care',
    img: 'https://loremflickr.com/600/440/dog,veterinarian,checkup?lock=102',
    alt: 'Dog getting a checkup at the vet',
    date: 'December 3, 2026 · admin',
  ...
  {
    tag: 'Education Pet',
    img: 'https://loremflickr.com/600/440/puppytraining,treat?lock=103',
    alt: 'Puppy training session with treats',
    date: 'December 3, 2026 · admin',
